...
if [[ $TRAVIS_OS_NAME == 'linux' ]]; then
	...
	"/c/Program Files (x86)/Microsoft Visual Studio/2019/Community/MSBuild/Current/Bin/MSBuild.exe" -t:giada -maxCpuCount -p:CL_MPCount=2  -p:Platform=x64 -p:Configuration="Release" build/giada.sln
